...
class TechnicianLoginVC: UIViewController {
    ...
    fileprivate func fetchUserInfoFromDB(withUID technicianKeyPath: String) {
        DatabaseManager.shared.getSpecificTechnician(technicianKeyPath: technicianKeyPath) { result in
            ...
            case .success(let userInfo):
                ...
                let accountType = userInfo.profileInfo.accountType
                let hourlyRate = userInfo.profileInfo.hourlyRate
                ...
                self.setUserPersistedData(data: technicianUserPersistedInfo)
...
extension TechnicianLoginVC: CollectionDataSourceAndDelegate {
