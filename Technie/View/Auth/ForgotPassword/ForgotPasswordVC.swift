...
class ForgotPasswordVC: UIViewController {
    ...
    lazy var emailTxtFld: HoshiTextField = {
        var txtFld = HoshiTextField()
        ...
        txtFld.placeholderFontScale = 0.85

        txtFld.isSecureTextEntry = true
        txtFld.autocorrectionType = .no
        txtFld.autocapitalizationType = .none

        txtFld.borderActiveColor = .systemPink
        txtFld.borderInactiveColor = .gray
